...
//自瞄击打前哨站下的PID参数
pid_t pid_yaw_station    = {0};
pid_t pid_pit_station    = {0};
pid_t pid_pit_speed_station    = {0};
pid_t pid_yaw_speed_station    = {0};
...
pid_t pid_yaw           = {0};
pid_t pid_pit           = {0};
pid_t pid_pit_safe			= {0};
pid_t pid_pit_speed_safe= {0};
...
pid_t pid_shoot_bullet_position_speed_loop = {0};   //用于连续射击前，下拨盘拨动一个角度的pid速度环控制器

pid_t pid_shoot_bullet_position_angle_loop_2 = {0};  //用于连续射击前，拨动一个角度的pid角度环控制器二级拨盘
pid_t pid_shoot_bullet_position_speed_loop_2= {0};   //用于连续射击前，拨动一个角度的pid速度环控制器

pid_t pid_remove_barrier[2] = {0};
pid_t pid_remove_barrier_speed[2] = {0};

pid_t pid_shoot_current[3] = {0};
